...
test('the authoring format imports and every set shows its governing prescription', async ({
  ...
  const expectedSets = [
    ...
    ['Bench Press', 'Set 1 of 3 · 8–12 reps'],
    ['Bench Press', 'Set 2 of 3 · 8–12 reps'],
    ['Bench Press', 'Set 3 of 3 · 8–12 reps'],
    ['Barbell Row', 'Set 1 of 3 · 8–12 reps'],
    ['Face Pull', 'Set 1 of 3 · 12–20 reps'],
    ['Barbell Row', 'Set 2 of 3 · 8–12 reps'],
    ['Face Pull', 'Set 2 of 3 · 12–20 reps'],
    ['Barbell Row', 'Set 3 of 3 · 8–12 reps'],
    ['Face Pull', 'Set 3 of 3 · 12–20 reps'],
  ] as const;
